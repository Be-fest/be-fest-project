...
const steps = [
	{
		...
		description:
			'Navegue pelas categorias de serviços e encontre exatamente o que precisa para sua festa.',
		icon: MdSearch,
	},
	{
		step: '02',
		...
		description:
			'Veja perfis detalhados, avaliações e preços de diferentes prestadores na sua região.',
		icon: MdCompare,
	},
	{
		step: '03',
		...
		description:
			'Entre em contato diretamente com o fornecedor e organize todos os detalhes da sua festa.',
		icon: MdHandshake,
	},
	{
		step: '04',
		...
		description:
			'Relaxe e aproveite sua festa perfeita, sabendo que tudo foi cuidadosamente planejado.',
		icon: MdCelebration,
	},
];
				...
				<div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
					{steps.map((item, index) => (
						...
						>
							...
							<h3 className="text-xl font-bold text-[#520029] mb-3 font-poppins">
								{item.title}
							</h3>
